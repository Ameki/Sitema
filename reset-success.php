...
<title><?php echo APP_NAME ?>:Restablecimiento con éxito</title>
...
<div id="center">
<h1>Restablecimiento de la contraseña con éxito</h1>
  <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
<p>&nbsp;</p>
<p><a href="login-register.php">Haga clic aquí</a> para acceder a su cuenta con su nueva contraseña.</p>
</div>
</div>
